...
var name4 = prompt("Enter your School Name");
document.getElementById("schoolname").innerText = name4;

var name5 = prompt("Enter your Annual Examination Year");
document.getElementById("annual").innerText = name5;

var name6 = prompt("Enter your College name").toLocaleUpperCase();
document.getElementById("collegename").innerText = name6;
